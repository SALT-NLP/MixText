...
Please download the dataset and put them in the data folder. You can find Yahoo Answers, AG News, [DB Pedia] (https://github.com/LC-John/Yahoo-Answers-Topic-Classification-Dataset), [IMDB] (https://www.kaggle.com/lakshmi25npathi/imdb-dataset-of-50k-movie-reviews).
